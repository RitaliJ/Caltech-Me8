...
while True:
    ...
    if t >= first_move and t < first_move + movement_time:
        vcmd = (p_final - p_init) / movement_time
        pcmd = p_init + vcmd * (t - first_move)
    elif t < first_move:
        pcmd = p_init
        vcmd = 0.0
    else:
...
ax1.set_title('Robot Data - Step 4 - Linear Movements')
